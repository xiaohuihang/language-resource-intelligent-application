...
def extract_features_and_labels(sentences):
    ...
    for data in sentences:
        ...
        for i, char in enumerate(text):
            ...
            # 实体边界指示特征
            if i > 0:
                feat['prev_is_O'] = char_labels[i - 1] == 'O'
                feat['prev_is_B'] = char_labels[i - 1].startswith('B-')
                feat['prev_is_I'] = char_labels[i - 1].startswith('I-')
